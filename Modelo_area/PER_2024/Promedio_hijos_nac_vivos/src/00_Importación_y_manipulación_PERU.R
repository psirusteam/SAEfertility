...
saveRDS(base_MEF, file ="Modelo_area/PER_2024/Promedio_hijos_nac_vivos/output/base_MEF.rds")
# --------------------------------------#
#            Births module              #
# --------------------------------------#
...
saveRDS(base_emb, file = "Modelo_area/PER_2024/Promedio_hijos_nac_vivos/output/base_nacimientos.rds")
