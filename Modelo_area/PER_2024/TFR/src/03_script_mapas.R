...
FH_estimacion_bench <- readRDS(
  "Modelo_area/PER_2024/TFR/output/estimacion_TFR_FH_bench_01102025.rds"
)
...
tmap_save(
  tmap_arrange(mapa),
  filename = file.path("Modelo_area/PER_2024/TFR/output/modelo_TFR_benchmarking_mapa.jpeg"),
...
tmap_save(
  ...
  filename = file.path("Modelo_area/PER_2024/TFR/output/modelo_FH_TFR_benchmarking_CV_mapa.jpeg"),
  width = 3000, height = 1500, dpi = 300
)
