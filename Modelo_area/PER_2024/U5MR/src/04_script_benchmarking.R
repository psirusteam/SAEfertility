...
IMR_cadena <- readRDS(
  "Modelo_area/PER_2024/IMR/output/estimacion_IMR_bench_binomial_draws_30092025.rds") 

CMR_cadena  <- readRDS(
  "Modelo_area/PER_2024/CMR/output/estimacion_CMR_bench_binomial_draws_30092025.rds") 
...
ggsave(plot = a,
       filename =  "Modelo_area/PER_2024/U5MR/output/modelo_FH_normal_benchmarking_30092025.jpeg",
       scale = 3)
...
saveRDS(
  U5MR_final,
  "Modelo_area/PER_2024/U5MR/output/estimacion_U5MR_FH_bench_30092025.rds"
)
