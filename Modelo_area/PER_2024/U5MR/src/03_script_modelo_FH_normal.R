...
est_dir <- est_dir %>%
  mutate(dame = as.character(dame),
         ...
         deff = if_else(is.na(deff) | deff <1, 1,deff),
...
saveRDS(object = model_FH_normal,
        file = "Modelo_area/PER_2024/U5MR/output/model_FH_normal.rds")

model_FH_normal <- readRDS(file = "Modelo_area/PER_2024/TFR/output/model_FH_normal.rds")
...
ggsave(plot = a,
       filename =  "Modelo_area/PER_2024/TFR/output/modelo_FH_normal.jpeg", 
       scale = 3)
...
ggsave(plot = a,
       filename =  "Modelo_area/PER_2024/TFR/output/modelo_FH_normal_comparaciones.jpeg", 
       scale = 3)
