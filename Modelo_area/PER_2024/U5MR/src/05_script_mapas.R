...
tmap_save(
  tmap_arrange(mapa),
  filename = file.path("Modelo_area/PER_2024/U5MR/output/modelo_FH_normal_benchmarking_mapa_30092025.jpeg"),
...
tmap_save(
  ...
  filename = file.path("Modelo_area/PER_2024/U5MR/output/modelo_FH_normal_benchmarking_CV_mapa_30093035.jpeg"),
  width = 3000, height = 1500, dpi = 300
)
