...
peru <- redatam.open("Modelo_area/PER_2024/ASFR/30-34/input/cpv-per-2017-cde_diccionario.dicx")
...
muj_30_34 <- CONTEOS2 %>%
  ...
  edad = C5P0412_value,
  value)%>%
  filter(edad >= 30 & edad <= 34 & sexo == 2) %>% group_by(dam,provi)%>%
...
saveRDS(muj_30_34, "Modelo_area/PER_2024/ASFR/30-34/output/censo_muj_30_34.rds")
saveRDS(muj_total, "Modelo_area/PER_2024/ASFR/30-34/output/censo_muj_total.rds")
...
saveRDS(
  hijos_nacidos,
  "Modelo_area/PER_2024/ASFR/30-34//output/censo_hijos_nacidos.rds"
)
...
saveRDS(statelevel_predictors_df, "Modelo_area/PER_2024/ASFR/30-34/input/statelevel_predictors_df_update_provi.rds")
...
saveRDS(statelevel_predictors_df_m, "Modelo_area/PER_2024/ASFR/30-34/input/statelevel_predictors_df_update_provi_muj.rds")
