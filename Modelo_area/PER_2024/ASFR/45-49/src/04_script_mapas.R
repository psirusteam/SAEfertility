...
FH_estimacion_bench <- readRDS(
  ...
  ASFR_45_49 = round(if_else(ASFR_45_49 < 1, 0,ASFR_45_49 ),3),
...
tmap_save(
  tmap_arrange(mapa),
  filename = file.path("Modelo_area/PER_2024/ASFR/45-49/output/modelo_FH_normal_benchmarking_mapa_01102025.jpeg"),
...
tmap_save(
  ...
  filename = file.path("Modelo_area/PER_2024/ASFR/45-49/output/modelo_FH_normal_benchmarking_CV_mapa_01102025.jpeg"),
  width = 3000, height = 1500, dpi = 300
)
