...
base_MEF <- read.csv("Modelo_area/PER_2024/ASFR/45-49/input/REC0111_2024.csv") # Modulo mujeres en edad fertil 12 - 49 años
...
base_emb <- read.csv("Modelo_area/PER_2024/ASFR/45-49/input/REC21_2024.csv") #Historial de embarazos
...
saveRDS(base_sae, "Modelo_area/PER_2024/ASFR/45-49/output/estimación_directa_phv.rds")
