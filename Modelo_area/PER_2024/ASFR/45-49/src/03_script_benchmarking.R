...
FH_estimacion <- readRDS(
  "Modelo_area/PER_2024/ASFR/45-49/output/estimacion_ASFR_binomial_01102025.rds") 

FH_cadena <- readRDS(
  "Modelo_area/PER_2024/ASFR/45-49/Cadenas_thetapred_01102025.rds") 
...
FH_estimacion <- FH_estimacion %>% filter(! theta_pred > 0.082925) 

censo <- readRDS(
  "Modelo_area/PER_2024/ASFR/45-49/output/censo_muj_45_49.rds")

Direct_estimation_dam <- readRDS(
  "Modelo_area/PER_2024/ASFR/45-49/output/estimación_directa_dam.rds") %>%
...
saveRDS(estimacionesBench_draws,"Modelo_area/PER_2024/ASFR/45-49/output/estimacion_ASFR_bench_binomial_draws_01102025.rds" )
...
ggsave(plot = a,
       filename =  "Modelo_area/PER_2024/ASFR/45-49/output/modelo_binomial_benchmarking_01102025.jpeg",
       scale = 3)
...
saveRDS(
  ASFR_final,
  "Modelo_area/PER_2024/ASFR/45-49/output/estimacion_ASFR_bench_binomial_01102025.rds"
)
