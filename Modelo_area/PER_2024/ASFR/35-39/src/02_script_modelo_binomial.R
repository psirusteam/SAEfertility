...
est_dir <- readRDS(
  "Modelo_area/PER_2024/ASFR/35-39/output/estimación_directa_phv.rds"
)
...
info_covariables <- readRDS("Modelo_area/PER_2024/ASFR/35-39/input/statelevel_predictors_df_update_provi_muj.rds") %>% mutate(dam = str_sub(provi, 1, 2))

info_satelitales <- readRDS("Modelo_area/PER_2024/ASFR/35-39/input/satelitales_provincia.rds") %>%
  rename(
    provi = provi,
...
saveRDS(object = model_FH_Binomial,
        file = "Modelo_area/PER_2024/ASFR/35-39/output/model_binomial_01102025.rds")

model_FH_Binomial <- readRDS(file = "Modelo_area/PER_2024/ASFR/35-39/output/model_binomial_01102025.rds")
...
ggsave(plot = a,
       filename =  "Modelo_area/PER_2024/ASFR/35-39/output/modelo_binomial_density.jpeg",
       scale = 5)
...
ggsave(plot = b,
       filename =  "Modelo_area/PER_2024/ASFR/35-39/output/modelo_binomial_density_sigma.jpeg",
       scale = 5)
...
saveRDS(object = posterior_theta,
        file = "Modelo_area/PER_2024/ASFR/35-39/output/Cadenas_thetapred_01102025.rds")
...
ggsave(plot = p_comb,
       filename =  "Modelo_area/PER_2024/ASFR/35-39/output/modelo_binomial_efectos_aleatorios.jpeg",
       scale = 5)


#Guardar la base de las estimaciones
saveRDS(data_estimation, "Modelo_area/PER_2024/ASFR/35-39/output/estimacion_ASFR_binomial_01102025.rds")
