...
tmap_save(
  tmap_arrange(mapa),
  filename = file.path("Modelo_area/PER_2024/ASFR/25-29/output/modelo_FH_normal_benchmarking_mapa_01102025.jpeg"),
...
tmap_save(
  ...
  filename = file.path("Modelo_area/PER_2024/ASFR/25-29/output/modelo_FH_normal_benchmarking_CV_mapa_01102025.jpeg"),
  width = 3000, height = 1500, dpi = 300
)
