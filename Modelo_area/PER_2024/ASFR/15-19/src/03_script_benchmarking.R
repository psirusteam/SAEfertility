...
FH_estimacion <- readRDS(
  "Modelo_area/PER_2024/ASFR/15-19/output/estimacion_ASFR_binomial_01102025.rds") 

FH_cadena <- readRDS(
  "Modelo_area/PER_2024/ASFR/15-19/output/Cadenas_thetapred_01102025.rds") 
...
FH_estimacion <- FH_estimacion %>% filter(! theta_pred > 0.314747) 

censo <- readRDS(
  "Modelo_area/PER_2024/ASFR/15-19/output/censo_muj_15_19.rds")
...
saveRDS(estimacionesBench_draws,"Modelo_area/PER_2024/ASFR/15-19/output/estimacion_ASFR_bench_binomial_draws_01102025.rds" )
...
ggsave(plot = a,
       filename =  "Modelo_area/PER_2024/ASFR/15-19/output/modelo_binomial_benchmarking_01102025.jpeg",
       scale = 3)
