...
FH_estimacion_bench <- readRDS(
  ...
  IMR_media = round(if_else(IMR_media < 1 , 0, IMR_media),2),
  IMR_cv = round(IMR_cv,3)
)
...
tmap_save(
  tmap_arrange(mapa),
  filename = file.path("Modelo_area/PER_2024/IMR/output/modelo_FH_normal_benchmarking_mapa_30092025.jpeg"),
...
tmap_save(
  ...
  filename = file.path("Modelo_area/PER_2024/IMR/output/modelo_FH_normal_benchmarking_CV_mapa_30092025.jpeg"),
  width = 3000, height = 1500, dpi = 300
)
