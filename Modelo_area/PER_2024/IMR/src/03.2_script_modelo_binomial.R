...
info_covariables <- readRDS("Modelo_area/PER_2024/IMR/input/statelevel_predictors_df_update_provi.rds") %>% mutate(dam = str_sub(provi, 1, 2))
...
y_effect  = ceiling((data_dir$IMR_2)*n_effec)
...
saveRDS(object = model_FH_Binomial,
        file = "Modelo_area/PER_2024/IMR/output/model_binomial_sobrevivencia_28092025.rds")

model_FH_Binomial <- readRDS(file = "Modelo_area/PER_2024/IMR/output/model_binomial_sobrevivencia_30092025.rds")
...
ppc_dens_overlay(y = as.numeric(data_dir$IMR_2), y_pred2)
...
saveRDS(object = posterior_theta,
        file = "Modelo_area/PER_2024/IMR/output/Cadenas_thetapred_30092025.rds")
...
ggsave(plot = p_comb,
       filename =  "Modelo_area/PER_2024/IMR/output/modelo_beta_efectos_aleatorios.jpeg",
       scale = 5)


#Guardar la base de las estimaciones
saveRDS(data_estimation, "Modelo_area/PER_2024/IMR/output/estimacion_IMR_FH_binomial_30092025.rds")
