...
peru <- redatam.open("Modelo_area/PER_2024/IMR/input/cpv-per-2017-cde_diccionario.dicx")
...
saveRDS(muj_15_49, "Modelo_area/PER_2024/IMR/output/censo_muj_15_49.rds")
saveRDS(muj_total, "Modelo_area/PER_2024/IMR/output/censo_muj_total.rds")
...
saveRDS(statelevel_predictors_df, "Modelo_area/PER_2024/IMR/input/statelevel_predictors_df_update_provi.rds")
...
saveRDS(statelevel_predictors_df_m, "Modelo_area/PER_2024/IMR/input/statelevel_predictors_df_update_provi_muj.rds")
